...
public class OrderItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4592655768749248592L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItem\",\"namespace\":\"com.whizpath.kafka.generated\",\"fields\":[{\"name\":\"itemName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"itemPrice\",\"type\":\"double\"}]}");
   ...
   */
  public static com.whizpath.kafka.generated.OrderItem.Builder newBuilder() {
    return new com.whizpath.kafka.generated.OrderItem.Builder();
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.whizpath.kafka.generated.OrderItem.Builder newBuilder(com.whizpath.kafka.generated.OrderItem.Builder other) {
    if (other == null) {
      return new com.whizpath.kafka.generated.OrderItem.Builder();
    } else {
      return new com.whizpath.kafka.generated.OrderItem.Builder(other);
    }
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.whizpath.kafka.generated.OrderItem.Builder newBuilder(com.whizpath.kafka.generated.OrderItem other) {
    if (other == null) {
      return new com.whizpath.kafka.generated.OrderItem.Builder();
    } else {
      return new com.whizpath.kafka.generated.OrderItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.whizpath.kafka.generated.OrderItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.whizpath.kafka.generated.OrderItem other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.itemName)) {
        this.itemName = data().deepCopy(fields()[0].schema(), other.itemName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.whizpath.kafka.generated.OrderItem.Builder setItemName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.whizpath.kafka.generated.OrderItem.Builder clearItemName() {
      itemName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.whizpath.kafka.generated.OrderItem.Builder setItemPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.whizpath.kafka.generated.OrderItem.Builder clearItemPrice() {
